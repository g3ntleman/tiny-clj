...
| `--quiet` | Minimale Ausgabe: Unterdrückt PASS-Zeilen und stdout von erfolgreichen Tests. Zeigt FAIL-Zeilen, Assertion-Details fehlschlagender Tests und die Zusammenfassung am Ende. | `--quiet` |
