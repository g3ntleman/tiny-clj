...
static void test_lower_bound_basic(void) {
    ...
    TEST_ASSERT_EQUAL_UINT32(0, (uint32_t)tdb_lower_bound_kv(e, 4, "a", 1));
    TEST_ASSERT_EQUAL_UINT32(1, (uint32_t)tdb_lower_bound_kv(e, 4, "aa", 2));
    TEST_ASSERT_EQUAL_UINT32(2, (uint32_t)tdb_lower_bound_kv(e, 4, "ab", 2));
    TEST_ASSERT_EQUAL_UINT32(3, (uint32_t)tdb_lower_bound_kv(e, 4, "b", 1));
...
static void test_iter_prefix_order(void) {
    ...
    seen_keys_t s = {0};
    TEST_ASSERT_EQUAL_INT(TDB_OK, tdb_iter_prefix_kv(e, 5, "a", 1, collect_keys_cb, &s));
    ...
    seen_keys_t s2 = {0};
    TEST_ASSERT_EQUAL_INT(TDB_OK, tdb_iter_prefix_kv(e, 5, "ab", 2, collect_keys_cb, &s2));
