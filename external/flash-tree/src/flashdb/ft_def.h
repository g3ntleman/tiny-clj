...
#define FDB_KVDB_CTRL_SET_SEC_SIZE                                                                 \
    0x00 /**< set sector size control command, this change MUST before database initialization */
...
#define FDB_KVDB_CTRL_SET_FILE_MODE                                                                \
    0x09 /**< set file mode control command, this change MUST before database initialization */
#define FDB_KVDB_CTRL_SET_MAX_SIZE                                                                 \
    0x0A /**< set database max size in file mode control command, this change MUST before database \
            initialization */
#define FDB_KVDB_CTRL_SET_NOT_FORMAT                                                               \
    0x0B /**< set database NOT format mode control command, this change MUST before database       \
            initialization */
...
#define FDB_TSDB_CTRL_SET_ROLLOVER                                                                 \
    0x04 /**< set rollover control command, this change MUST after database initialization */
...
#define FDB_TSDB_CTRL_SET_NOT_FORMAT                                                               \
    0x0B /**< set database NOT formatable mode control command, this change MUST before database   \
            initialization */
