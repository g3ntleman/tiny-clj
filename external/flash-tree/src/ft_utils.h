// ft_utils.h - Common utility functions for flash-tree.
//
 ...
 */
static inline uint32_t ft_max_u32(uint32_t a, uint32_t b) {
    return (a > b) ? a : b;
}
 ...
 */
static inline uint32_t ft_min_u32(uint32_t a, uint32_t b) {
    return (a < b) ? a : b;
}
 ...
 */
static inline int ft_is_pow2(uint32_t x) {
    return x && ((x & (x - 1u)) == 0);
}
 ...
 */
static inline int ft_is_aligned(uint32_t addr, uint32_t gran) {
 ...
 */
static inline int ft_is_len_aligned(size_t len, uint32_t gran) {
