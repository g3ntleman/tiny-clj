...
;; tiny-gfx.converter
;;
;; Consolidated conversion/codegen helpers for tiny-gfx:
...
(defn emit-record-enum
  ...
  (let [lines (loop [i 0
                ...
                (if (empty? fs)
                  out
                  (let [field (first fs)
                        line (str "  " prefix "_IDX_" (tiny-gfx.converter/kw->c-token field) " = " i ",")]
...
(defn c-header-string
  ...
  []
  (str "/* Auto-generated by tiny-gfx.converter. */\n"
       "#ifndef TINY_GFX_SCENE_LAYOUT_H\n"
       "#define TINY_GFX_SCENE_LAYOUT_H\n\n"
       (str/join "\n"
                 (map tiny-gfx.converter/emit-record-enum record-layouts))
