...
if(TINYCLJ_PRODUCT STREQUAL "tiny-clj")
  set(TINY_FX_ENABLED OFF CACHE BOOL "Build tiny-fx native feature set" FORCE)
  set(TINYCLJ_SOUND_ENABLED ON CACHE BOOL "Build tiny-clj sound native feature set" FORCE)
elseif(TINYCLJ_PRODUCT STREQUAL "tiny-fx")
  set(TINY_FX_ENABLED ON CACHE BOOL "Build tiny-fx native feature set" FORCE)
  set(TINYCLJ_SOUND_ENABLED ON CACHE BOOL "Build tiny-clj sound native feature set" FORCE)
else()
...
if(TINY_FX_ENABLED)
  idf_build_set_property(COMPILE_DEFINITIONS "TINY_FX_ENABLED=1" APPEND)
else()
  idf_build_set_property(COMPILE_DEFINITIONS "TINY_FX_ENABLED=0" APPEND)
endif()
if(TINYCLJ_SOUND_ENABLED)
  idf_build_set_property(COMPILE_DEFINITIONS "TINYCLJ_SOUND_ENABLED=1" APPEND)
else()
  idf_build_set_property(COMPILE_DEFINITIONS "TINYCLJ_SOUND_ENABLED=0" APPEND)
endif()
