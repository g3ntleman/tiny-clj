...
TEST(test_memory_leak_fibonacci_reproduction) {
    ...
    CljValue fib10_result = eval_string(fib10_code, g_test_eval_state);
    ...
    CljValue fib15_result = eval_string(fib15_code, g_test_eval_state);
...
TEST(test_nested_recursive_functions_no_leak) {
    ...
    CljValue fact_result = eval_string(fact_code, g_test_eval_state);
    CljValue fib_result = eval_string(fib_code, g_test_eval_state);
...
TEST(test_recursive_calls_without_closure_env_caching) {
    ...
    CljValue countdown_result = eval_string(countdown_code, g_test_eval_state);
    ...
    CljValue countdown20_result = eval_string(countdown20_code, g_test_eval_state);
