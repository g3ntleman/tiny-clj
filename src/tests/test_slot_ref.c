...
TEST(test_slot_ref_nested_fn_rewrites_free_var_depth1) {
    ...
    TEST_ASSERT_EQUAL_INT_MESSAGE(CLJ_SLOT_REF, TAG(arg_a), "a should be rewritten to SlotRef");
    ...
    TEST_ASSERT_EQUAL_INT_MESSAGE(CLJ_SLOT_REF, TAG(arg_b), "b should be rewritten to SlotRef");
