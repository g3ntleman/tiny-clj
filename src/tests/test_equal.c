...
TEST_SHARED(test_vector_equal_same_vectors) {
    ...
    vec1_val = (CljValue)vector_conj((CljPersistentVector*)vec1_val, val1);
    vec1_val = (CljValue)vector_conj((CljPersistentVector*)vec1_val, val2);
    vec1_val = (CljValue)vector_conj((CljPersistentVector*)vec1_val, val3);
    
    vec2_val = (CljValue)vector_conj((CljPersistentVector*)vec2_val, val1);
    vec2_val = (CljValue)vector_conj((CljPersistentVector*)vec2_val, val2);
    vec2_val = (CljValue)vector_conj((CljPersistentVector*)vec2_val, val3);
...
TEST_SHARED(test_vector_equal_different_values) {
    ...
    vec1_val = (CljValue)vector_conj((CljPersistentVector*)vec1_val, int1);
    vec1_val = (CljValue)vector_conj((CljPersistentVector*)vec1_val, int2);
    vec2_val = (CljValue)vector_conj((CljPersistentVector*)vec2_val, int3);
    vec2_val = (CljValue)vector_conj((CljPersistentVector*)vec2_val, int4);
...
TEST_SHARED(test_vector_equal_with_strings) {
    ...
    vec1_val = (CljValue)vector_conj((CljPersistentVector*)vec1_val, str1);
    vec1_val = (CljValue)vector_conj((CljPersistentVector*)vec1_val, str2);
    
    vec2_val = (CljValue)vector_conj((CljPersistentVector*)vec2_val, str3);
    vec2_val = (CljValue)vector_conj((CljPersistentVector*)vec2_val, str4);
