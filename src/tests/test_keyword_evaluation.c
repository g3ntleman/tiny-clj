...
TEST(test_keyword_evaluates_to_itself) {
    ...
    CljValue result = eval_string(":done", st);
...
TEST(test_keyword_in_function_body) {
    ...
    TRY {
        ...
        CljValue result = eval_string("((fn [] :done))", st);
...
TEST(test_keyword_in_if_statement) {
    ...
    TRY {
        ...
        CljValue result = eval_string("(if true :yes :no)", st);
        ...
        result = eval_string("(if false :yes :no)", st);
...
TEST(test_keyword_in_recur_function) {
    ...
    TRY {
        ...
        CljValue result = eval_string("(if true :done :not-done)", st);
        TEST_ASSERT_NOT_NULL(result);
        TEST_ASSERT_TRUE(is_type((CljObject*)result, CLJ_SYMBOL));
        ...
        result = eval_string("(if false :not-done :done)", st);
        TEST_ASSERT_NOT_NULL(result);
        TEST_ASSERT_TRUE(is_type((CljObject*)result, CLJ_SYMBOL));
...
TEST(test_keyword_in_let_binding) {
    ...
    CljValue result = eval_string("(let [x :done] x)", st);
...
TEST(test_keyword_in_nested_function_call) {
    ...
    TRY {
        ...
        CljValue result = eval_string("((fn [] :active))", st);
        TEST_ASSERT_NOT_NULL(result);
        TEST_ASSERT_TRUE(is_type((CljObject*)result, CLJ_SYMBOL));
        ...
        result = eval_string("((fn [x] (if x :active :inactive)) true)", st);
        TEST_ASSERT_NOT_NULL(result);
        TEST_ASSERT_TRUE(is_type((CljObject*)result, CLJ_SYMBOL));
