...
TEST(test_breakout_contract_scene_build_returns_entity_map_root_with_spatial_rules) {
    ...
    ID ok = eval_string(
        ...
        "        breakout-test-brick-rule (nth breakout-test-rules 1)] "
        "    (and (= true (:visible breakout-test-frame)) "
        "         (= :tiny-fx.scene/root-entity breakout-test-root-id) "
        "         (= :tiny-fx.scene/root-entity (:id breakout-test-root)) "
        ...
        "         (= :ball (:self breakout-test-brick-rule)) "
