...
TEST(test_eval_body_with_params_fixnum_literal) {
    ...
    TEST_ASSERT_EQUAL_INT(CLJ_FIXNUM, TAG(fixnum_one));
    ...
    TEST_ASSERT_EQUAL_INT_MESSAGE(CLJ_FIXNUM, TAG(result), "Result should be a Fixnum");
...
TEST(test_eval_body_with_params_fixnum_with_params) {
    ...
    TEST_ASSERT_EQUAL_INT(CLJ_FIXNUM, TAG(fixnum_value));
...
TEST(test_eval_body_with_params_fixnum_in_arithmetic) {
    ...
    TEST_ASSERT_EQUAL_INT(CLJ_FIXNUM, TAG(fixnum_n));
