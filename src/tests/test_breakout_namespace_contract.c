...
TEST(test_breakout_namespace_contract_deployment_routes_through_tiny_breakout) {
    ...
    TEST_ASSERT_NOT_NULL_MESSAGE(strstr(src, "[tiny-breakout.core"),
                                 "deployment namespace should require tiny-breakout.core");
    TEST_ASSERT_NOT_NULL_MESSAGE(strstr(src, "[tiny-breakout.scene"),
                                 "deployment namespace should require tiny-breakout.scene");
    TEST_ASSERT_NULL_MESSAGE(strstr(src, "tiny-fx.game-demo"),
