...
;; - group-from-svg
;;
;; Supported SVG subset (intentionally small):
;; - <line x1 y1 x2 y2 .../>
;; - <rect x y w h .../>
...
;; - stroke, stroke-width
;; - fill (currently parsed as fallback stroke color until fill rendering lands)
;; - visibility/display (none/hidden => visible false)
;; - style="k:v; k:v" inline declarations
;;
;; Important constraints:
;; - Coordinates are parsed as integers. Decimal input is truncated toward zero.
;; - This importer does not load files; use composition at call sites, e.g.:
;;   (-> (slurp "asset.svg") (tiny-drw.svg/group-from-svg))
