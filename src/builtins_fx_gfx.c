...
void builtins_fx_gfx_reset_cached_state(void) {
}
 ...
 */
bool builtins_fx_gfx_register_slot_bindings(ID slot_atoms) {
...
ID native_tinyclj_runtime_start_renderer(ID *args, unsigned int argc) {
    ...
    if (argc == 1) {
        ...
        if (!builtins_fx_gfx_register_slot_bindings(slot_atoms)) {
            throw_exception(EXCEPTION_ILLEGAL_ARGUMENT,
